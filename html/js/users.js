  ...
  .then(jsondata => {
    ...
    users.map(function(user){
      ...
      mainDiv.classList.add("dropstart","font-sans-serif","position-static","d-inline-block");
      let viewButton = document.createElement('button');
      viewButton.classList.add("btn","btn-link","text-600","btn-sm","btn-reveal","float-end");
      ...
      hideMenu.classList.add("dropdown-menu","dropdown-menu-end","border","py-2");
  ...
  .catch(function(error) {
    ...
    td.classList.add("align-middle","align-middle","text-center","text-dark","bg-warning","px-1");
